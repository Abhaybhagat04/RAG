...
async def query_documents(request: QueryRequest):
    ...
    system_message = (
        ...
        "Format your response with clear short headings, bullet points, numbered lists, code blocks, "
        "or tables when appropriate. Do not use bold markers like **text**. "
        "Prefer concise sections over long paragraphs. "
